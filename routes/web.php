...
Route::name('activity.')->prefix('activity')->group(function() {
    // Activity Profile
    Route::get('/createActivityProfile/{id}', 'ActivityController@createActivityProfile')->name('createActivityProfile')->middleware('can:manage-activity-profile');

    Route::post('/storeActivityProfile', 'ActivityController@storeActivityProfile')->name('storeActivityProfile')->middleware('can:manage-activity-profile');
    
    Route::put('updateActivityProfile/{id}', 'ActivityController@updateActivityProfile')->name('updateActivityProfile')->middleware('can:manage-activity-profile');   

    Route::delete('/{id}', 'ActivityController@destroyActivityProfile')->name('destroyActivityProfile')->middleware('can:manage-activity-profile');
...
Route::name('activity_repair.')->prefix('activity_repair')->group(function() {
    // Activity Profile
    Route::get('/createActivityProfile/{id}', 'ActivityController@createActivityProfile')->name('createActivityProfile')->middleware('can:manage-activity-profile-repair');

    Route::post('/storeActivityProfile', 'ActivityController@storeActivityProfile')->name('storeActivityProfile')->middleware('can:manage-activity-profile-repair');
    
    Route::put('updateActivityProfile/{id}', 'ActivityController@updateActivityProfile')->name('updateActivityProfile')->middleware('can:manage-activity-profile-repair');    

    Route::delete('/{id}', 'ActivityController@destroyActivityProfile')->name('destroyActivityProfile')->middleware('can:manage-activity-profile-repair');
