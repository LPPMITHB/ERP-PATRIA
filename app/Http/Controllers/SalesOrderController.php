...
class SalesOrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $sales_order->customer_id = ($data->pd->customer_id != "") ? $data->pd->customer_id : null;
            $sales_order->description = $data->pd->description;
            $sales_order->price = $data->pd->price;
            $sales_order->total_price = $data->pd->total_price;
            $sales_order->margin = $data->pd->margin;
