...
class CreateMstBomPrepBuildingTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mst_bom_prep_building', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('mst_bom_prep_building');
    }
}
