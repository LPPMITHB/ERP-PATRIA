...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // $yardPlan = Menu::where('name', 'Yard Plan')->where('menu_id', $building)->select('id')->first()->id;
        // DB::table('menus')->insert([
        //     'level' => 4,
        ...
        //     'updated_at' => date('Y-m-d')
        // ]);
        // $yardPlanRepair = Menu::where('name', 'Yard Plan')->where('menu_id', $repair)->select('id')->first()->id;
        // DB::table('menus')->insert([
        //     'level' => 3,
        //     'name' => 'View Yard Plan',
        //     'icon' => 'fa-wrench',
        ...
        ///
        $this->call(BuildingMenuSeeder::class);
        $this->call(RepairMenuSeeder::class);
