...
class SidenavsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $wbsProfile = Menu::where('route_name','project.indexWbsProfile')->select('id')->first()->id;
        DB::table('sidenav')->insert([
            'menu_id' => $wbsProfile,
            'route_name' => 'project.indexWbsProfile',
        ]);

        $wbsProfileRepair = Menu::where('route_name','project_repair.indexWbsProfile')->select('id')->first()->id;
        DB::table('sidenav')->insert([
            'menu_id' => $wbsProfileRepair,
            'route_name' => 'project_repair.indexWbsProfile',
        ]);
