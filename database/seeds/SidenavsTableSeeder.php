...
class SidenavsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // DB::table('sidenav')->insert([
        //     'menu_id' => $createQcTaskBuilding,
        //     'route_name' => 'qc_task_repair.selectWBS',
        // ]);

        // //Qc Task Repair
        // $selectProjectQcTaskRepair = Menu::where('route_name', 'qc_task_repair.selectProject')->select('id')->first()->id;
        // DB::table('sidenav')->insert([
        //     'menu_id' => $selectProjectQcTaskRepair,
        //     'route_name' => 'qc_task_repair.selectProject',
        // ]);

        // // $createQcTaskRepair = Menu::where('route_name', 'qc_task_repair.create')->select('id')->first()->id;
        // // DB::table('sidenav')->insert([
