    ...
    <div class="col-xs-12 p-b-50">
        <div class="box">
            <div class="box-body no-padding p-b-10">
                <form id="create-bom" class="form-horizontal" method="POST" action="{{ route('qc_type.store') }}">
                    @csrf
                    @verbatim
                    <div id="bom">
                        <div class="box-header p-b-0">
                            <div class="col-xs-12 col-md-4">
                                ...
                                <div class="col-xs-12 no-padding">
                                    <input class="form-control" type="text" v-model="input.qct_name">
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-4">
    ...
    var vm = new Vue({
        ...
        methods: {
            ...
            getNewMaterials(jsonMaterialId) {
                window.axios.get('/api/getMaterialsBOM/' + jsonMaterialId).then(({
                        data
                    }) => {
                        this.materials = data;
                        $('div.overlay').hide();
            ...
            update(old_material_id, new_material_id) {
                this.materialTable.forEach(material => {
                    if (material.material_id == old_material_id) {
                        ...
                        window.axios.get('/api/getMaterialBOM/' + new_material_id).then(({
                                data
                            }) => {
        ...
        watch: {
            'input.material_id': function(newValue) {
                ...
                if (newValue != "") {
                    ...
                    window.axios.get('/api/getMaterialBOM/' + newValue).then(({
                        data
                    }) => {
