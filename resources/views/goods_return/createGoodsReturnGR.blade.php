                            ...
                            <div class="box-header">
                                <div class="col-xs-12 col-lg-6 col-md-12 no-padding">
                                    <div class="box-body no-padding">
                                        ...
                                        <div class="col-md-8 col-xs-8 no-padding"><b>: @endverbatim<a href= "{{ route('goods_receipt.show', ['id'=>$modelGR->id]) }}" class="text-primary">@verbatim{{ modelGR.number }}</a>
                                        </b></div>

                                        <div class="col-md-4 col-xs-4 no-padding" v-if="is_pami">PO Number</div>
                                        <div class="col-md-8 col-xs-8 no-padding" v-if="is_pami"><b>: @endverbatim<a href= "{{ route('purchase_order.show', ['id'=>$modelGR->purchaseOrder->id]) }}" class="text-primary">@verbatim{{ Po_number }}</a></b></div>

                                        <div class="col-md-4 col-xs-4 no-padding" v-if="is_pami">PR Number</div>
                                        <div class="col-md-8 col-xs-8 no-padding" v-if="is_pami"><b>: @endverbatim<a href= "{{ route('purchase_requisition.show', ['id'=>$modelGR->purchaseOrder->purchaseRequisition->id]) }}" class="text-primary">@verbatim{{ Pr_number }}</a></b></div>
