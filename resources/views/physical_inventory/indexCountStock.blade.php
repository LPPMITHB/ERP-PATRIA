                        ...
                        @foreach ($snapshots as $snapshot)
                            <tr>
                                ...
                                <td class="p-l-0 textCenter">
                                    @if($menu == "building")
                                        <a class="btn btn-primary btn-xs" href="{{route('physical_inventory.countStock', ['id' => $snapshot->id])}}">
                                            SELECT
                                        </a>
                                    @else
                                        <a class="btn btn-primary btn-xs" href="{{route('physical_inventory_repair.countStock', ['id' => $snapshot->id])}}">
                                            SELECT
                                        </a>
                                    @endif
                                </td>
