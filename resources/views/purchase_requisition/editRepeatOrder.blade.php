...
@if($route == "/purchase_requisition")
    @breadcrumb(
        [
            'title' => 'Edit Repeat Order » '.$newNumber.' - '.$type,
            'items' => [
                'Dashboard' => route('index'),
                'Repeat Order' => route('purchase_requisition.repeatOrder'),
                'Edit Repeat Order' => '',
            ]
        ]
    )
...
@elseif($route == "/purchase_requisition_repair")
    @breadcrumb(
        [
            ...
            'items' => [
                'Dashboard' => route('index'),
                'Repeat Order' => route('purchase_requisition_repair.repeatOrder'),
                'Edit Repeat Order' => '',
            ]
        ]
    )
...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body">
                @if($route == "/purchase_requisition")
                    <form id="edit-pr" class="form-horizontal" method="POST" action="{{ route('purchase_requisition.storeRepeatOrder') }}">
                @elseif($route == "/purchase_requisition_repair")
                    <form id="edit-pr" class="form-horizontal" method="POST" action="{{ route('purchase_requisition_repair.storeRepeatOrder') }}">
                @endif
                @csrf
                    @verbatim
                    <div id="pr">
