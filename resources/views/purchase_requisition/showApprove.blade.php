            ...
            <div class="box-body p-t-0 p-b-0">
                ...
                @if($modelPR->status == 1 || $modelPR->status == 4)
                    <div class="col-md-12 m-b-10 p-r-0">
                        @if($route == "/purchase_requisition")
                            <a class="col-xs-12 col-md-1 btn btn-primary pull-right m-l-10 m-t-5" href="{{ route('purchase_requisition.approval', ['id'=>$modelPR->id,'status'=>'approve']) }}">APPROVE</a>
                            <a class="col-xs-12 col-md-2 btn btn-danger pull-right m-l-10 p-r-10 m-t-5" href="{{ route('purchase_requisition.approval', ['id'=>$modelPR->id,'status'=>'need-revision']) }}">NEEDS REVISION</a>
                            <a class="col-xs-12 col-md-1 btn btn-danger pull-right p-r-10 m-t-5" href="{{ route('purchase_requisition.approval', ['id'=>$modelPR->id,'status'=>'reject']) }}">REJECT</a>
                        @elseif($route == "/purchase_requisition_repair")
                            <a class="col-xs-12 col-md-1 btn btn-primary pull-right m-l-10 m-t-5" href="{{ route('purchase_requisition_repair.approval', ['id'=>$modelPR->id,'status'=>'approve']) }}">APPROVE</a>
                            <a class="col-xs-12 col-md-2 btn btn-danger pull-right m-l-10 p-r-10 m-t-5" href="{{ route('purchase_requisition_repair.approval', ['id'=>$modelPR->id,'status'=>'need-revision']) }}">NEEDS REVISION</a>
                            <a class="col-xs-12 col-md-1 btn btn-danger pull-right p-r-10 m-t-5" href="{{ route('purchase_requisition_repair.approval', ['id'=>$modelPR->id,'status'=>'reject']) }}">REJECT</a>
                        @endif
                    </div>
                @endif
            </div> <!-- /.box-body -->
