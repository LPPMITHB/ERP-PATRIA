                ...
                @if($modelPR->status == 1 || $modelPR->status == 4)
                    <div class="col-md-12 m-b-10 p-r-0 p-t-10">
                        @if($route == "/purchase_requisition")
                            ...
                            <a class="col-xs-12 col-md-1 btn btn-danger pull-right m-l-10 p-r-10 m-t-5" href="{{ route('purchase_requisition.approval', ['id'=>$modelPR->id,'status'=>'need-revision']) }}">REVISE</a>
                        ...
                        @elseif($route == "/purchase_requisition_repair")
                            ...
                            <a class="col-xs-12 col-md-1 btn btn-danger pull-right m-l-10 p-r-10 m-t-5" href="{{ route('purchase_requisition_repair.approval', ['id'=>$modelPR->id,'status'=>'need-revision']) }}">REVISE</a>
