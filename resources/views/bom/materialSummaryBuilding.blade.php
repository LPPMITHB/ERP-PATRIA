...
<div class="row">
    <div class="col-xs-12">
        <div class="box">
            <div class="box-body">
                <form id="create-bom" class="form-horizontal" method="POST" action="{{ route('bom.storeBom') }}">
                @csrf
                </form>
                @verbatim
                <div id="mrd">
                    <div class="box-header">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-lg-4 col-md-4">
                                ...
                                <div class="col-md-7 col-xs-8 no-padding"><b>: {{modelWbs.number}}</b></div>
                            
                                <div class="col-md-3 col-xs-4 no-padding">Description</div>
                                <div class="col-md-7 col-xs-8 no-padding"><b>: {{modelWbs.description}}</b></div>
                            
                                <div class="col-md-3 col-xs-4 no-padding">Deliverable</div>
                                <div class="col-md-7 col-xs-8 no-padding tdEllipsis" data-container="body" data-toggle="tooltip"><b>:
                                        {{modelWbs.deliverables}}</b></div>
                            
                                <div class="col-md-3 col-xs-4 no-padding">Start Date</div>
                                <div class="col-md-7 col-xs-8 no-padding"><b>: {{modelProject.planned_start_date}}</b>
                                </div>
                            
                                <div class="col-md-3 col-xs-4 no-padding">End Date</div>
                                <div class="col-md-7 col-xs-8 no-padding"><b>: {{modelProject.planned_end_date}}</b>
                                </div>
                            </div>
    ...
    var vm = new Vue({
        ...
        methods : {
            ...
            submitForm(){
                ...
                this.submittedForm.wbs_id = this.modelWbs.id;
