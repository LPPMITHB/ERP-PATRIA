    ...
    $(document).ready(function() {
        ...
        var data = {
            ...
            submittedForm: {
                ...
                dimension_type_id: "",
                location_detail: "",
                standard_price_config: "1",
                standard_price_config_range: "1",
            },
            uom_settings: {
        ...
        var vm = new Vue({
            ...
            watch: {
                ...
                'submittedForm.standard_price_config': function(newValue) {
                    this.selectedPriceType = newValue;
                },
                selectedDimensionType: {
