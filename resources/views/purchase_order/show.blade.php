        ...
        <div class="box box-blue">
            ...
            <div class="box-body">
                ...
                <div class="col-md-12 m-b-10 p-r-0 p-t-10">
                    @if($route == "/purchase_order" && $modelPO->purchaseRequisition->type == 3)
                        <a class="col-xs-12 col-md-2 btn btn-primary pull-right" href="{{ route('purchase_order_repair.printJobOrder', ['id'=>$modelPO->id]) }}">DOWNLOAD JOB ORDER</a>
                    @endif
                </div>
                <div class="col-md-12 m-b-10 p-r-0 p-t-10">
                    @if($route == "/purchase_order")
