...
@section('content-header')
    @breadcrumb(
        [
            'title' => 'View Delivery Document » Select Project',
            'items' => [
                            ...
                            <tr>
                                ...
                                <td class="p-l-5 p-r-5" align="center">
                                    @if($route == "/delivery_document")
                                        <a class="btn btn-primary btn-xs" href="{{ route('delivery_document.show', ['id'=>$project->id]) }}">SELECT</a>
                                    @elseif($route == "/delivery_document_repair")
                                        <a class="btn btn-primary btn-xs" href="{{ route('delivery_document_repair.show', ['id'=>$project->id]) }}">SELECT</a>
                                    @endif
                                </td>
                            </tr>
                        @endforeach
